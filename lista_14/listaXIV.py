...
def derivada(coef):
    ...
    for i in range(1, len(coef)):
        derivada_coef.append(coef[i] * i)
    return derivada_coef
...
def soma(n1, n2):
    ...
    for i in range(len(n1)):
        soma_digito = n1[i] + n2[i] + carry
        resultado.append(soma_digito % 10)
        carry = soma_digito // 10
